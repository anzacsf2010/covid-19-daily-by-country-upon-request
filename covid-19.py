...
# -------------------------------------------#
"""
Script: This is a simple tool that allows a user to enter any
country that has been reported cases on COVID-19, and then show a data frame for the said county
along with the visualization from Jan 22 to date.
